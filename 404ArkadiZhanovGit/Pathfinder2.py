...
def initialize_map_and_plot(start_point, target_point):
    ...
    # MODDED : Muted legal traversal plot, the colored geometries on the map
    ...
    print('AStar distance (km):', astar_distance)
    print('Dijkstra distance (km):', djikstra_distance)
    if (astar_distance > djikstra_distance):
        print('dijkstra better')
    else:
        print('astar better')
...
# case 5
# tlat, tlon = 30.620470, -96.337469
# tpoint = (tlon, tlat)
# tlat2, tlon2 = 30.621069, -96.335457
# tpoint2 = (tlon2, tlat2)

# case 6
# tlat, tlon = 30.612365, -96.340249
# tpoint = (tlon, tlat)
# tlat2, tlon2 = 30.611964, -96.337760
# tpoint2 = (tlon2, tlat2)

# case 7
# tlat, tlon = 30.612365, -96.340249
# tpoint = (tlon, tlat)
# tlat2, tlon2 = 30.609074, -96.334720
# tpoint2 = (tlon2, tlat2)

# case 8
# tlat, tlon = 30.609074, -96.334720
# tpoint = (tlon, tlat)
# tlat2, tlon2 = 30.62331, -96.33402
# tpoint2 = (tlon2, tlat2)

# case 9
# tlat, tlon = 30.61200, -96.33128
# tpoint = (tlon, tlat)
# tlat2, tlon2 = 30.62034, -96.34205
# tpoint2 = (tlon2, tlat2)

# case 10
# tlat, tlon = 30.62059, -96.33954
# tpoint = (tlon, tlat)
# tlat2, tlon2 = 30.61320, -96.33461
# tpoint2 = (tlon2, tlat2)

# case 11
# tlat, tlon = 30.6202, -96.3376
# tpoint = (tlon, tlat)
# tlat2, tlon2 = 30.61587, -96.33654
# tpoint2 = (tlon2, tlat2)

# case 12 (Test trail in front of Zach by capstone room)
tlat, tlon = 30.62106, -96.33951  # start
tpoint = (tlon, tlat)
tlat2, tlon2 = 30.62071, -96.34042  # end
tpoint2 = (tlon2, tlat2)
