...
def pathfinder(start_point, target_point):
    ...
    # return djikstra_np_array # returns an np array
    return djikstra_np_array.tolist()


# TEST CASES (TEST POINTS) ; INPUTTING COORDINATES ###################################################

# CASE 1
# tlat, tlon = 30.625489, -96.33693 # run
# tpoint = (tlon, tlat) # run
# tlat2, tlon2 = 30.622441, -96.33453 # run
# tpoint2 = (tlon2, tlat2)

# RUN HERE #######################################################
# make a case a above and assign to tpoint and tpoint2
# start_point = tpoint # run
# target_point = tpoint2 # run
# ax_general = pathfinder(start_point, target_point) # this was for plotting
# print(pathfinder(start_point, target_point)) # run
# print(pathfinder(start_point, target_point).tolist()) # run
